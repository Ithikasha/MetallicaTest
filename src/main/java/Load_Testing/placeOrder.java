...
//			functions.bulkOrder_testing("Excelsheets","Bulk Order.xls","RegressionOrders",16,"Regression");

			functions.BulkOrder_International("Excelsheets","Bulk Order.xls","RegressionInternational",11,"Regression");
